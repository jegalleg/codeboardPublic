...
var config = require('../config/config'),
  //ide = require('~/codeboard/app/scripts/controllers/ide.js'),
...
var addActionLog = function (req, startTime, data, error) {
  ...
  if (data.id == undefined || (data.language == 'Eiffel' && data.clean)) {
    description = "first time" + error + logData + global.aNewlyReceivedData;
  }
  else {
...
var addActionLog2 = function (req, startTime, data, error) {
  var startTime = new Date(startTime);
  var id = data.id;
  var language = data.project.language;
  var action = data.action;
...
var showCompilationPerDayLogsByUser = function (startDate, endDate, user, projectId, res) {
  var startDate1 = new Date(startDate);
  var endDate1 = new Date(endDate);
  startDate1.setHours(0, 0, 0, 0);
  endDate1.setHours(23, 59, 59, 59);
  ...
  var result = {};
  var filterCompiler, filterRun, filterTest, filterTool;
  if (projectId == undefined) {//retrieve all projects
    filterCompiler = {
      $match: {
        $and: [
          { action: "compile" },
  ...
  compilerModel.aggregate(filterCompiler,
    /*{
      $group: {
        _id: { year: { $year: "$startTime" }, month: { $month: "$startTime" }, day: { $dayOfMonth: "$startTime" },projectId:"$projectId"},
        // projectId:{$push: {"projectId":"$projectId","cuenta":{$sum: 1}}},
        cuentaProyecto: { $sum: 1 },//cuentaProyecto guarda el numero de compilaciones de cada proyecto por cada dia
      }
    ...
    },
    {
      $group: {
        _id: { year: { $year: "$startTime" }, month: { $month: "$startTime" }, day: { $dayOfMonth: "$startTime" }  },
        //countProyectos: {$push: {projectId:"$projectId"}},
        //_id: { year: "$_id.year", month: "$_id.month", day: "$_id.day" },
        projectId: { $push: { projectId: "$_id.projectId", total: "$cuentaProyecto" } },
        //projectId:{$sum: 1},
        totalTime: { $sum: "$time" },
        averageTime: { $avg: "$time" },
        min: { $min: "$time" },
...
var showCompilationPerDayLogsByUserError = function (startDate, endDate, user, projectId, res) {
  var startDate1 = new Date(startDate);
  var endDate1 = new Date(endDate);
  startDate1.setHours(0, 0, 0, 0);
  endDate1.setHours(23, 59, 59, 59);
    ...
    filterCompiler = {
      $match: {
        $and: [
          ...
          { userName: user },
          { endTime: { $gte: inputStartDate, $lte: inputEndDate } },
          { description: { $regex: "1 error" } }//get only compilation errors
        ]
      }
    };
    filterRun = {
      $match: {
        $and: [
          ...
          { userName: user },
          { endTime: { $gte: inputStartDate, $lte: inputEndDate } }, //{ $gte: 1, $lt: 8 }
          { description: { $regex: "Exception" } }//get only execution errors
        ]
      }
    };
    filterTest = {
...
/**Function to get the comp run data for one user grouped by projects
 * 
 */
var showCompilationPerProjectLogsByUser = function (startDate, endDate, user, projectId, res) {
  var startDate1 = new Date(startDate);
  var endDate1 = new Date(endDate);
  startDate1.setHours(0, 0, 0, 0);
  endDate1.setHours(23, 59, 59, 59);
 ...
 * 
 */
var showCompilationDetailPerProjectLogsByUser = function (startDate, endDate, user, projectId, res) {
  var startDate1 = new Date(startDate);
  var endDate1 = new Date(endDate);
  startDate1.setHours(0, 0, 0, 0);
  endDate1.setHours(23, 59, 59, 59);
...
/**Function to get the comp runs data for specific user grouped by date for one specific project*/

var showUserCompilationPerProject = function (startDate, endDate, user, projectId, res) {
  var startDate1 = new Date(startDate);
  var endDate1 = new Date(endDate);
  startDate1.setHours(0, 0, 0, 0);
  endDate1.setHours(23, 59, 59, 59);
...
//JESUS
var showProjectAccessPerDayLogsByUser = function (startDate, endDate, projectId, user, res) {
  var startDate1 = new Date(startDate);
  var endDate1 = new Date(endDate);
  startDate1.setHours(0, 0, 0, 0);
  endDate1.setHours(23, 59, 59, 59);
 ...
 * Show a summary of the project access for a particular projectId, grouped by user
 */
var showProjectAccessPerProject2 = function (startDate, endDate, res) {
  var startDate1 = new Date(startDate);
  var endDate1 = new Date(endDate);
  startDate1.setHours(0, 0, 0, 0);
  endDate1.setHours(23, 59, 59, 59);
...
var showProjectAccessLogsPerProject = function (startDate, endDate, projectId, res, userName) {
  var startDate1 = new Date(startDate);
  var endDate1 = new Date(endDate);
  startDate1.setHours(0, 0, 0, 0);
  endDate1.setHours(23, 59, 59, 59);
...
exports.showUserCompilationPerProject = showUserCompilationPerProject;
exports.showCompilationPerDayLogsByUser = showCompilationPerDayLogsByUser;//used for user stats  comp runs brouped by date
exports.showProjectAccessPerDayLogsByUser = showProjectAccessPerDayLogsByUser;//used for user stats accesses grouped by date
exports.showCompilationPerProjectLogsByUser = showCompilationPerProjectLogsByUser;//used for user stats comp runs grouped by projects
exports.showCompilationDetailPerProjectLogsByUser = showCompilationDetailPerProjectLogsByUser;//used for user stats comp runs ERRORS grouped by projects
exports.showCompilationPerDayLogsByUserError = showCompilationPerDayLogsByUserError;//used for user stats  comp runs ERRORS brouped by date
exports.showProjectAccessLogsPerProject = showProjectAccessLogsPerProject;//used for user stats access grouped by projects
exports.addActionLog = addActionLog;
exports.addActionLog2 = addActionLog2;
...
exports.showProjectAccessPerProject2 = showProjectAccessPerProject2;
