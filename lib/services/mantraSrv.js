  ...
  return request.postAsync({url: url, json: true, headers: headersContent, body: aPostData})
    .spread(function (res, resBody) {
      ...
      if (res.statusCode >= 400) {
        ...
        //$log.debug('Código de error de la compilación: '+ errPayload.statusCode);
        console.log('Código de error de la compilación: '+ errPayload.statusCode);
        console.log('Mensaje de error de la compilación: '+ errPayload.msg);
        ...
        //$log.debug('payload id: '+successPayload.id);
