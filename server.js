...
//ESTO ES DE  PRUEBA!
var key = fs.readFileSync('../CERTIFICADO/codeboard.gast.it/codeboard.gast.it.key');
var cert = fs.readFileSync( '../CERTIFICADO/codeboard.gast.it_uc3m_es_2962883/codeboard_gast_it_uc3m_es_2962883/codeboard_gast_it_uc3m_es.crt' );
...
var printear = function(texto){
  console.log(texto);
}
process.env.NODE_TLS_REJECT_UNAUTHORIZED = "0"
//JESUS PRUEBA
//Al no tener certificate de ca, dice que el sitio no es seguro
//habria que ver como conseguir uno al meterlo bajo el dominio de la uc3m
...
server.on('upgrade', function(req, socket, head) {
  ...
  wsLoadBalancer.ws(req, socket, head, options);
});
